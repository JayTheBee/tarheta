                                ...
                                <div tabindex="0" class="preview-des">
                                    ...
                                    <?php if ($question['question_type'] == 'CHOICE'): 
                                        foreach($multi_choices as $multi_choice):
                                            ...
                                            <div class="choices-small-ver"><?php echo $multi_choice['choiceA'] ?></div>
                                            <div class="choices-small-ver"><?php echo $multi_choice['choiceB'] ?></div>
                                            <div class="choices-small-ver"><?php echo $multi_choice['choiceC'] ?></div>
                                            <div class="choices-small-ver"><?php echo $multi_choice['choiceD'] ?></div>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    ...
                                    <div class="answer">
                                        ...
                                        <span class="answer-here">
                                            <div class="answer-add-style">
                                                <input type="text" id="choice-answer-a" name="choice-answer-a" placeholder="A Option (required)" class="input-style">
