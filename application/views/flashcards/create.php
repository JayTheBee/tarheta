...
<div class="custom-bg-create">
  ...
  <div id="FlashcardCreate" class="container ">

    <!-- <div class="wave-size-bg"> -->
            ...
            <div class="eROoTb">
              ...
              <div class="summary-title">
                ...
                <div class="st-titlebox">
                  <input placeholder="Enter Tarheta title... Maximum of 70 characters" class="form-control st-titleinput" maxlength="70" aria-label="Tarheta title. 70 characters left." dir="auto" value="" name="name" id="name" aria-describedby="name" type="text" />
              ...
              <div class="form-group ivjskN">
                <label id="description" class="lezPrD">Description
                  <span class="lgIHpf">(Optional)</span>
                </label>
                <div class="gJtIs">
                  <textarea class="hgbfPN form-control" rows="5" maxlength="300" aria-labelledby="description pro-tip-text description-characters-left" dir="auto" type="text" placeholder="Flashcard description. Maximum of 300 characters" name="description" id="description"></textarea>
                  <!-- max word 
                    <div class="fUZYzw">
                      <span
                        class="hTDhsC jAWBEq"
                ...
                <label id="pro-tip-text" class="knnLTA">Pro tip: a good description will help other users find your
