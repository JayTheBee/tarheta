<div class="container">
        <div class="row">
            ...
            <div class="card" style="margin-top: 5rem">
                ...
                <input type="text" placeholder="Enter classname (course, teacher, year, section)" name="class_name" value="<?php echo set_value('class_name'); ?>" class="form-control" id="class_name" aria-describedby="name"> 
