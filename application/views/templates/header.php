        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse show" id="navbarCollapse">
                <ul class="navbar-nav flex-row flex-wrap ms-auto pt-2 py-md-0">
                    ...
                    <li class="nav-item col-6 col-md-auto px-lg-5 px-3"><a class="nav-link" href="<?php echo base_url(); ?>features">FEATURES</a></li>
                    <li class="nav-item col-6 col-md-auto px-lg-5 px-3"><a class="nav-link" href="<?php echo base_url(); ?>developers">DEVELOPERS</a></li>
                </ul>
                <div class="ms-auto">
